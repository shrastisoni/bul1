	...
	<div class="row">
		...
		<div class="col-md-3 sidebar">
			...
			@if($business->businessId)
				...
				<div ng-hide="!edit.social">
					<span>
						<img src="images/icons/facebook.png" class="social-icon"><input style="width: 136px" type="text"  />
					</span>
					<span>
						<img src="/images/icons/twitter.png" class="social-icon"><input style="width: 136px" type="text"  />
					</span>
					<span>
						<img src="images/icons/google-plus.png" class="social-icon"><input style="width: 136px" type="text"  />
					</span>
				</div>
	                    ...
	                    <div class="modal-content">
	                    	...
	                    	<form>
		                        <div class="form-group">
		                            ...
		                            <input style="margin: 0 !important" type="text" class="form-control" ng-model="business.contact" placeholder="Contact...">
		                        </div>
		                        <div class="form-group">
		                            <label for="inputPassword">Location:</label>
		                            <input style="margin: 0 !important" type="text" class="form-control" ng-model="business.location" placeholder="Location...">
		                        </div>
		                        <div class="form-group">
		                            <label for="inputPassword">Servicing:</label>
		                            <input style="margin: 0 !important" type="text" class="form-control" ng-model="business.servicing" placeholder="Servicing...">
		                        </div>
		                        <div class="form-group">
		                            <label for="inputPassword">Phone:</label>
		                            <input style="margin: 0 !important" type="text" class="form-control" ng-model="business.phone" placeholder="Phone...">
		                        </div>
		                        <div class="form-group">
		                            <label for="inputPassword">Web:</label>
		                            <input style="margin: 0 !important" type="text" class="form-control" ng-model="business.link"  placeholder="Website Link...">
		                        </div>

		                       <div class="form-group">
		                            <label for="inputPassword"><img src="images/icons/facebook.png" class="social-icon"></label>
		                            <input style="margin: 0 !important" type="text" class="form-control" ng-model="business.facebook"   placeholder="Facebook...">
		                        </div>
		                        <div class="form-group">
		                            <label for="inputPassword"><img src="/images/icons/twitter.png" class="social-icon"></label>
		                            <input style="margin: 0 !important" type="text" class="form-control" ng-model="business.twitter"  placeholder="twitter...">
		                        </div>
		                        <div class="form-group">
		                            <label for="inputPassword"><img src="images/icons/google-plus.png" class="social-icon"></label>
		                            <input style="margin: 0 !important" type="text" class="form-control" ng-model="business.google" placeholder="google +...">
		                        </div>
	          ...
	          angular.module('profileUpdate', ['imageupload'], function($interpolateProvider, $compileProvider) {
	            ...
	            .controller('profileUpdateController', function($scope, $http) {
	            	...
	            	$scope.makeEditableFunc = function(inputId) {
	            		$scope.edit.name.disabled = !($scope.edit.name.disabled);
	            		$scope.edit.serviceCoverage.disabled = !($scope.edit.serviceCoverage.disabled);
	            		$scope.edit.location.disabled = !($scope.edit.location.disabled);
	            		$scope.edit.phone.disabled = !($scope.edit.phone.disabled);
	            		$scope.edit.website.disabled = !($scope.edit.website.disabled);
	            		$scope.edit.social = !$scope.edit.social;
				        if (inputId.disabled)
				        {
				        	$scope.edit.name.classStyle = "profileEditDisableInput";
				        	$scope.edit.serviceCoverage.classStyle = "profileEditDisableInput";
				        	$scope.edit.location.classStyle = "profileEditDisableInput";
				        	$scope.edit.phone.classStyle = "profileEditDisableInput";
				        	$scope.edit.website.classStyle = "profileEditDisableInput";
				        }
				        else
				        {
				        	$scope.edit.name.classStyle = "profileEditEnableInput";
				        	$scope.edit.serviceCoverage.classStyle = "profileEditEnableInput";
				        	$scope.edit.location.classStyle = "profileEditEnableInput";
				        	$scope.edit.phone.classStyle = "profileEditEnableInput";
				        	$scope.edit.website.classStyle = "profileEditEnableInput";
