				...
				<div class="navbar-header">
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
						<ul class="nav navbar-nav navbar-right">
							<a href="#">Home</a><a href="#">Businesses</a><a href="#" class="active">Gray Filly</a>
						</ul>
					</div>
				</div>
		...
		<header>
			<div class="container">
				<div class="update-cover-photo">
					<a href="#"><img src="/images/icons/camera.png"> <span>Update Banner Photo</span></a>
				</div>
				<div class="col-lg-3">
					<a href="#" class="update-profile-photo"><img src="/images/icons/camera.png" class="icon"><span>Update Photo/Logo</span></a>
					<img src="/images/bg-logo.png" class="upload-logo">
				</div>
				<div class="col-lg-9">
