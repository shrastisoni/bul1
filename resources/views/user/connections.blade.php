...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-9 content">
			<h2 class="content-heading"><img src="/images/icons/social-circle-dark.png" class="icon">My Connections</h2>
			...
			<h3 class="content-sub-heading">Connections <span class="counter blue">(40)</span></h3>
